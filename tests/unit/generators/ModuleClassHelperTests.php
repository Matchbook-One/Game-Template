...
namespace fhnw\gamecenter\tests\units\generators;

use Codeception\Test\Unit;
use fhnw\gamecenter\gii\generators\ModuleClassHelper;
use fhnw\gamecenter\tests\UnitTester;


class ModuleClassHelperTest extends Unit
{
  /** @var UnitTester */
